...
export default createStore({
  state: {
    ...
    listAnnees:["2025","2024", "2020-2023"], 
    echelle:null,
    filterCode:null,
    filterTheme:null,
    themeColor:'gray',
  ...
  mutations: {
      ...
      for(let i = 0;i<state.data.length;i++) {
        ...
        switch (sous_theme) {
          ...
          case "6.2":
            ...
            break;
          case "6.3":
            sous_theme =  "6.3 - Pilotage, ingénierie, ressources et évaluations"
            break;
          case "6.4":
    ...
    async CHANGE_ANNEE(state, annee) {
      if (annee === "2020-2023") {
        ...
        window.open("https://cartes.anct.gouv.fr/vie-associative/#/panorama/contrat-de-ville", "_blank");
      } else {
